import{a as e,l as t,n,p as r,r as i,t as a,u as o}from"./fs-access-D-fDaJ8V-w6cEwJE-.js";import{B as s,C as c,J as l,N as u,R as d,X as f,gt as p,i as m}from"./dist-Zx1cCqpr.js";var h=class{constructor(e){if(this.baseUrl=e.url,e.username!==void 0){let t=`${e.username}:${e.password??``}`;this.authHeader=`Basic ${btoa(t)}`}}async propfind(e,t=1){let n=await fetch(new URL(e,this.baseUrl).href,{method:`PROPFIND`,headers:this.buildHeaders({Depth:t.toString(),"Content-Type":`application/xml`}),body:`<?xml version="1.0" encoding="UTF-8"?>

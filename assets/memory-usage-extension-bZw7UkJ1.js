import{m as c,s as d,j as o,f as u,T as l}from"./main-DBFD4j53.js";var m=Object.getOwnPropertyDescriptor,g=(e,n,i,a)=>{for(var t=a>1?void 0:a?m(n,i):n,s=e.length-1,r;s>=0;s--)(r=e[s])&&(t=r(t)||t);return t};let p=class extends d{constructor(){super(...arguments),this.updateInterval=null}connectedCallback(){super.connectedCallback(),this.updateInterval=window.setInterval(()=>{this.requestUpdate()},2e3)}disconnectedCallback(){super.disconnectedCallback(),this.updateInterval!==null&&(clearInterval(this.updateInterval),this.updateInterval=null)}render(){const e=performance.memory;if(!e)return o``;const n=(e.usedJSHeapSize/1048576).toFixed(1),i=(e.jsHeapSizeLimit/1048576).toFixed(0),a=e.usedJSHeapSize/e.jsHeapSizeLimit*100,t=a.toFixed(0),s=a>80?"#ff4444":a>60?"#ffaa00":"#44aa44";return o`

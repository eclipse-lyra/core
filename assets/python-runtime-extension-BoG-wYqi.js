const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/python-editor-BR7FeOds.js","assets/vendor-DlX8FWQM.js","assets/vendor-CTYeukuQ.css","assets/monaco-Cp131h44.js","assets/monaco-Dvl_Svmm.css","assets/pyservice-Cj8IzRi8.js","assets/package-manager-HxM004Ot.js","assets/pglite-FiEFosRY.js"])))=>i.map(i=>d[i]);
import{d as h,_ as y}from"./vendor-DlX8FWQM.js";import{w as g,c as u,r as l,t as f,j as m,I as v}from"./monaco-Cp131h44.js";import{T as P}from"./pglite-FiEFosRY.js";import{P as s}from"./pyservice-Cj8IzRi8.js";import{p as c}from"./package-manager-HxM004Ot.js";class _{constructor(){this.id="python",this.label="Python",this.language="python",this.pyenv=null,this.requiredPackages=[]}async connect(t){if(this.pyenv)return;this.requiredPackages=t?.requiredPackages??[],this.pyenv=new s;const e=await g.getWorkspace();await this.pyenv.init(e),this.requiredPackages.length>0&&await this.pyenv.loadPackages(this.requiredPackages);try{await this.pyenv.execCode(`
try:
    import matplotlib
    matplotlib.use('agg')

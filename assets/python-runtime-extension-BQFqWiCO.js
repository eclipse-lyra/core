const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/python-editor-LTwGzSKL.js","assets/vendor-CbQe4k-6.js","assets/vendor-CTYeukuQ.css","assets/monaco-wqKCAqma.js","assets/monaco-Dvl_Svmm.css","assets/pyservice-BgffyEt2.js","assets/package-manager-BgG47JEJ.js","assets/pglite-8u3caWn4.js"])))=>i.map(i=>d[i]);
import{d as h,_ as y}from"./vendor-CbQe4k-6.js";import{w as g,c as u,r as l,t as f,j as m,F as v}from"./monaco-wqKCAqma.js";import{T as P}from"./pglite-8u3caWn4.js";import{P as s}from"./pyservice-BgffyEt2.js";import{p as c}from"./package-manager-BgG47JEJ.js";class _{constructor(){this.id="python",this.label="Python",this.language="python",this.pyenv=null,this.requiredPackages=[]}async connect(t){if(this.pyenv)return;this.requiredPackages=t?.requiredPackages??[],this.pyenv=new s;const e=await g.getWorkspace();await this.pyenv.init(e),this.requiredPackages.length>0&&await this.pyenv.loadPackages(this.requiredPackages);try{await this.pyenv.execCode(`
try:
    import matplotlib
    matplotlib.use('agg')

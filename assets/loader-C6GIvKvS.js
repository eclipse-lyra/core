import{b,e as f,j as g,d as i,k as p,t as C}from"./vendor-DlX8FWQM.js";import{L as y,s as T,z as w,A as x,c as d,B as u,C as s,D as $,F as S}from"./monaco-Cp131h44.js";var A=Object.defineProperty,I=Object.getOwnPropertyDescriptor,h=(e,t,o,r)=>{for(var n=r>1?void 0:r?I(t,o):t,l=e.length-1,c;l>=0;l--)(c=e[l])&&(n=(r?c(t,o,n):c(n))||n);return r&&n&&A(t,o,n),n};const m="catalog.root";let a=class extends y{constructor(){super(...arguments),this.treeRef=g()}doBeforeUI(){this.rebuildTree(),this.contributionsSubscriptionToken=T(w,e=>{(e.target===m||e.target?.startsWith("catalog."))&&this.rebuildTree()})}doClose(){this.contributionsSubscriptionToken&&(x(this.contributionsSubscriptionToken),this.contributionsSubscriptionToken=void 0),super.doClose()}rebuildTree(){const e=d.getContributions(m);this.rootNodes=this.toTreeNodes(e),this.requestUpdate()}renderToolbar(){const e=u.get()instanceof a&&s.get()!==void 0;return i`
            <lyra-command
    ...
    `;h([f()],a.prototype,"rootNodes",2);a=h([C("lyra-catalog")],a);d.registerContribution(S,{name:"catalog",label:"Catalog",icon:"book",component:e=>i`<lyra-catalog id="${e}"></lyra-catalog>`});
